...
| 명령어 | 설명 |
|--------|------|
| `/plan <주제>` | 계획 모드 (토론 후 구현 적용 제안) |
| `/i <주제>` | 인터랙티브 3자 토론 (나 + Codex + Claude) |
...
**인터랙티브 모드**(`-i` 또는 `/i`)에서는 제3의 참가자로 토론에 참여합니다 — 각 라운드가 끝난 후 직접 의견을 추가하거나, 토론 방향을 조정하거나, 다음 라운드 전에 에이전트에게 반론을 제기할 수 있습니다.
